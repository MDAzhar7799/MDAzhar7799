...
msg = MIMEMultipart()
msg['From'] = f'Azhar-foodExp Notifications <{sender_email}>'
msg['To'] = to_email
msg['Subject'] = 'Test - Azhar-foodExp MailerSend Setup'

body = """<html>
<body style="font-family:Arial,sans-serif;padding:20px">
<h2 style="color:#16a34a">MailerSend Setup Successful!</h2>
<p>Azhar-foodExp notification system is now connected to <strong>MailerSend</strong>.</p>
<p>Order Ready notifications will now be sent via this email service.</p>
<hr>
<p style="color:#888;font-size:12px">Azhar-foodExp - LPU &amp; LawGate Food Platform</p>
</body>
</html>"""
